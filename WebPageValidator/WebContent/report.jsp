...
<%
	if(session.getAttribute("urlList") != null){
		...
		ArrayList<String> allURL = (ArrayList<String>)session.getAttribute("urlList");
		
		for(int k=0;k<allURL.size();k++){
			
			String url = allURL.get(k);
...
<div id='accordion-<%=k %>' role="tablist">
  
  <%-- HTML --%>
  <div class="card">
  
    <div class="card-header" role="tab" id='headingOne-<%=k %>' >
      <h5 class="mb-0">
        <a class="collapsed" data-toggle="collapse" href='#collapseOne-<%=k %>' aria-expanded="false" aria-controls='collapseOne-<%=k %>' >
    ...
    <div id='collapseOne-<%=k %>' class="collapse" role="tabpanel" aria-labelledby='headingOne-<%=k %>' data-parent='#accordion-<%=k %>'>
      <div class="card-body">
  ...
  <div class="card">
    ...
    <div class="card-header" role="tab" id='headingTwo-<%=k %>' >
      <h5 class="mb-0">
        <a class="collapsed" data-toggle="collapse" href='#collapseTwo-<%=k %>' aria-expanded="false" aria-controls='collapseTwo-<%=k %>' >
         CSS Validation Report ->
        </a>
      </h5>
    </div>
    <div id='collapseTwo-<%=k %>' class="collapse" role="tabpanel" aria-labelledby='headingTwo-<%=k %>' data-parent='#accordion-<%=k %>'>
      <div class="card-body">
  ...
  <%-- JS --%>
  <div class="card">
    <div class="card-header" role="tab" id='headingThree-<%=k %>' >
      <h5 class="mb-0">
        <a class="collapsed" data-toggle="collapse" href='#collapseThree-<%=k %>' aria-expanded="false" aria-controls='collapseThree-<%=k %>' >
          JavaScript Validation Report ->
        </a>
      </h5>
    </div>
    <div id='collapseThree-<%=k %>' class="collapse" role="tabpanel" aria-labelledby='headingThree-<%=k %>' data-parent='#accordion-<%=k %>'>
      <div class="card-body">
	...
	<div class="card">
    <div class="card-header" role="tab" id='headingFour-<%=k %>'>
      <h5 class="mb-0">
        <a class="collapsed" data-toggle="collapse" href='#collapseFour-<%=k %>' aria-expanded="false" aria-controls='collapseFour-<%=k %>'>
          Broken Link Checker ->
        </a>
      </h5>
    </div>
    <div id='collapseFour-<%=k %>' class="collapse" role="tabpanel" aria-labelledby="headingFour" data-parent='#accordion-<%=k %>'>
      <div class="card-body">
